...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'os5000' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/talos/talos-ros-robot/install/${idir}'.  Ask the maintainer 'Thomas Denewiler <tdenewiler@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/talos/talos-ros-robot/install/lib;/home/talos/kalibr_workspace/devel/lib;/opt/ros/kinetic/lib)
